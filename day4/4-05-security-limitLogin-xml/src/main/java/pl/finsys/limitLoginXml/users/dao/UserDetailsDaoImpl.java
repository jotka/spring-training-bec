...
public class UserDetailsDaoImpl extends JdbcDaoSupport implements UserDetailsDao {
    ...
    private static final String SQL_USER_ATTEMPTS_INSERT =
        "INSERT INTO SECURITY_USER_ATTEMPTS (USERNAME, ATTEMPTS, LASTMODIFIED) VALUES(?,?,?)";

    private static final String SQL_USER_ATTEMPTS_UPDATE_ATTEMPTS =
        "UPDATE SECURITY_USER_ATTEMPTS SET attempts = attempts + 1, lastmodified = ? WHERE username = ?";
    private static final String SQL_USER_ATTEMPTS_RESET_ATTEMPTS =
        "UPDATE SECURITY_USER_ATTEMPTS SET attempts = 0, lastmodified = null WHERE username = ?";
